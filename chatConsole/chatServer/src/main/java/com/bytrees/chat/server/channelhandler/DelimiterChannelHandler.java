...
public class DelimiterChannelHandler extends ChannelInboundHandlerAdapter {
	...
	public void channelRead(ChannelHandlerContext ctx, Object msg) {
		...
		//向客户端发送信息
		ctx.write(Unpooled.copiedBuffer(new StringBuilder(in).append(";").toString(), CharsetUtil.UTF_8));
